...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.compaction.thinking":
    'Optional thinking override used only for compaction summarization. Accepts the same levels as normal thinking controls (for example "off", "low", or "adaptive") and falls back to the caller\'s current think level when unset.',
